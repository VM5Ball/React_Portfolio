        ...
        <div className="about__content">
          <div className="about__cards">
            ...
            <article className='about__card'>
              ...
              <h5>Проекты</h5>
              <small>5+ Выполненных проектов</small>
            </article>
            </div>
            <p>
              Привет! Меня зовут Владимир, я занимаюсь разработкой на Python и аналитикой данных на SQL. В данных момент прохожу обучение в Финансовом Университете при Правительстве РФ по направлению "Прикладная информатика", изучаю информационные сервисы в финансовых структурах. Стал чемпионом кейс-чемпионата Phystech Business Solutions на треке DeFi Analytics.
            </p>
